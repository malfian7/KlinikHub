...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image02', { style: 'fade-down', speed: 1500, intensity: 5, delay: 1500, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1750, intensity: 5, delay: 250, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1500, intensity: 5, delay: 750, replay: false });
		onvisible.add('#buttons03', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('#image08', { style: 'fade-down', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#image04', { style: 'fade-down', speed: 1500, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image03', { style: 'fade-down', speed: 1500, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style15, h2.style15, h3.style15, p.style15', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style14, h2.style14, h3.style14, p.style14', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#list01', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('.image.style1', { style: 'fade-down', speed: 1500, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#image13', { style: 'fade-down', speed: 1500, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style20, h2.style20, h3.style20, p.style20', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style21, h2.style21, h3.style21, p.style21', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#image14', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#image15', { style: 'fade-up', speed: 1000, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style22, h2.style22, h3.style22, p.style22', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style23, h2.style23, h3.style23, p.style23', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#image16', { style: 'fade-up', speed: 1000, intensity: 5, delay: 750, replay: false });
		onvisible.add('#image18', { style: 'fade-up', speed: 1000, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style12, h2.style12, h3.style12, p.style12', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style13, h2.style13, h3.style13, p.style13', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style16, h2.style16, h3.style16, p.style16', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style17, h2.style17, h3.style17, p.style17', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style18, h2.style18, h3.style18, p.style18', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style19, h2.style19, h3.style19, p.style19', { style: 'fade-up', speed: 1750, intensity: 5, delay: 875, replay: false });
		onvisible.add('#image17', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#image09', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#image11', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('h1.style11, h2.style11, h3.style11, p.style11', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#buttons04', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('#list04', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#list03', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#buttons02', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('h1.style24, h2.style24, h3.style24, p.style24', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('h1.style25, h2.style25, h3.style25, p.style25', { style: 'fade-up', speed: 1750, intensity: 5, delay: 500, replay: false });
		onvisible.add('#image19', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#text39', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#text18', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#text41', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#text40', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#text38', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#text17', { style: 'fade-up', speed: 1500, intensity: 5, delay: 875, replay: false });
		onvisible.add('#buttons07', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('#buttons06', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('#buttons05', { style: 'fade-in', speed: 1125, intensity: 5, delay: 1125, replay: false });
		onvisible.add('#text36', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
		onvisible.add('#text37', { style: 'fade-up', speed: 1750, intensity: 5, delay: 750, replay: false });
